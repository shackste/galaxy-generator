...
import big.layers as layers
from big.sync_batchnorm import SynchronizedBatchNorm2d as SyncBatchNorm2d
...
class Generator(NeuralNetwork):
  def __init__(self, G_ch=64, dim_z=128, bottom_width=4, resolution=64,
...
class Discriminator(NeuralNetwork):
  ...
  def __init__(self, D_ch=64, D_wide=True, resolution=64,
