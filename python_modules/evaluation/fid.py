...
from .dataset import infinite_loader
...
def extract_model_features(model: nn.Module,
    ...
    Args:
        ...
        dataset: dataset, used to sample labels from
        device:
    ...
    # create data loader, to sample labels from
    dl = infinite_loader(DataLoader(dataset, batch_size=batch_size, shuffle=True, drop_last=True))
...
def fid_generator(generator: nn.Module, dataset: Dataset,
    ...
    Args:
        generator: generator to compute FID score
        dataset: dataset to sample labels from
        ref_mean: reference mean value, computed for real images
        ref_cov: reference covariance value, computed for real images
    ...
    gen_feat = extract_model_features(model=generator,
                                      inception=inception,
                                      dataset=dataset,
                                      device=device,
